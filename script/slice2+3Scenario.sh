...
sudo ovs-ofctl add-flow s1 ip,priority=65500,nw_src=10.0.0.7,idle_timeout=0,actions=set_queue:345,output:5

# [SWITCH 2]
sudo ovs-ofctl add-flow s2 ip,priority=65500,in_port=2,idle_timeout=0,actions=set_queue:345,output:1
sudo ovs-ofctl add-flow s2 ip,priority=65500,nw_src=10.0.0.6,idle_timeout=0,actions=set_queue:345,output:2
